...
iterations = ceiling(length(historic_ids)/500) - 1 # create a number of iterations based on groups of 500 ids
...
for(i in 0:iterations) {
  active_ids <- paste0(historic_ids[((i*500)+1):((i+1)*500)], sep = ",", collapse = "") # getting the groupings of 500 ids
